import { BoundingBox, BoundingSphere, Matrix, Vector3 } from '@dgret/engine-math';
...
describe('BoundingBox test', () => {
  ...
  it('getCorners', () => {
    ...
    const expectedCorners = [new Vector3(), new Vector3(), new Vector3(), new Vector3(), new Vector3(), new Vector3(), new Vector3(), new Vector3()];
    ...
    const corners = [new Vector3(), new Vector3(), new Vector3(), new Vector3(), new Vector3(), new Vector3(), new Vector3(), new Vector3()];
